...
- Vue 3 & Nuxt 3, React & Next.js 생태계 전문
- 디자인이 가능한 프론트엔드 개발자
- 깔끔한 코드와 최적화된 성능을 중시
- 모노레포 아키텍처 및 클라우드 인프라 학습 중
...
| ------------------------------ | ---------- | ---------------------------------------------------- | ------- | ----------- | ----------------------------------------------------- |
| **SIB Contents 영화사 사이트** | Full Stack | Vue 3, Nuxt 3, Tailwind CSS, Turborepo, NAS Synology | 1주     | Completeds  | [sibcts.com](https://sibcts.com/)                     |
...
<div align="center">
  <img src="https://github-readme-stats.vercel.app/api/top-langs/?username=99yang&layout=compact&hide_border=true&bg_color=white&title_color=000000&text_color=333333" alt="Top Languages" />
</div>
...
💻 **GitHub** · [@99yang](https://github.com/99yang)
